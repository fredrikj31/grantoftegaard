...
export const vegetables: Product[] = [
  ...
  { id: "veg-7", name: "Gulerød (5 stk)", price: 20, emoji: "🥕", index: 7 },
  { id: "veg-8", name: "Hvidkål", price: 25, emoji: "🥬", index: 8 },
  { id: "veg-9", name: "Hvidløg", price: 15, emoji: "🧄", index: 9 },
  { id: "veg-10", name: "Kartofler alm.", price: 25, emoji: "🥔", index: 10 },
  { id: "veg-11", name: "Kartofler rød", price: 25, emoji: "🥔", index: 11 },
  ...
  { id: "veg-19", name: "Regnbue Bladebeder", price: 30, emoji: "🌈", index: 19 },
  { id: "veg-20", name: "Rød Grønkål", price: 30, emoji: "🥬", index: 20 },
  { id: "veg-21", name: "Rød Spidskål", price: 30, emoji: "🥬", index: 21 },
  { id: "veg-22", name: "Rødbeder (3 stk)", price: 25, emoji: "🍠", index: 22 },
